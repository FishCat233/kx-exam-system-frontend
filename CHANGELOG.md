...
## [0.1.11](https://github.com/FishCat233/kx-exam-system-frontend/compare/v0.1.10...v0.1.11) (2026-08-14)
...
* 考生登录页显示系统版本号（取自 package.json） ([39981b1](https://github.com/FishCat233/kx-exam-system-frontend/commit/39981b164e87f569937bb521340194e0db84a42d))
...
* **admin:** 移除 Select 的 tooltip 属性，兼容旧版 antd 构建 ([76a4e9b](https://github.com/FishCat233/kx-exam-system-frontend/commit/76a4e9bc9ddc75b121f79870368dbd39cb557693))
...
* **build:** 移除 Select 的 tooltip 属性，并将类型检查改为 tsc -b 修复空检查 ([a410fe9](https://github.com/FishCat233/kx-exam-system-frontend/commit/a410fe9f2d5a2e06d71efca63b04e8ab1f302bae))
...
* release 标题对齐后端为 v${version} 格式 [skip ci] ([093a904](https://github.com/FishCat233/kx-exam-system-frontend/commit/093a9043c4f846b14d5315e7ba045a7ebb86cf10))
* release-please PR 格式与后端对齐（标题 Release ${version}，恢复 emoji 分区） ([8d6bb58](https://github.com/FishCat233/kx-exam-system-frontend/commit/8d6bb5846d7f71eb4abab10c6cb1ec47a05c8cec))
...
* 显式关闭 include-component-in-tag，修复 tag 带组件前缀问题 ([eba5442](https://github.com/FishCat233/kx-exam-system-frontend/commit/eba5442a96ad89c4694747fce455a0f849305ccc))
